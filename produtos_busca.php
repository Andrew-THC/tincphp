    ...
    <div class="container">
        ...
        <?php if($numLinhas>0){?>
            <h2 class="breadcrumb alert-danger">
                ...
                <strong><?php echo $busca;?></strong>
            </h2>
            <div class="row">
                <?php do{ ?>
                    <div class="col-sm-6 col-md-4">
                        <div class="thumbnail">
                            <a href="produto_detalhes.php?id_produto=<?php echo $rowBusca['id']?>">
                                <img src="img/<?php echo $rowBusca['imagem']?>" class="img-responsive img-rounded">
                            </a>
