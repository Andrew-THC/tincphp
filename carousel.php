    <div id="banners" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="img/headset-banner.jpg" alt="" class="center-block">
            </div>
            <div class="item ">
                <img src="img/banner de ihpone.jpg" alt="" class="center-block">
            </div>
            <div class="item ">
                <img src="img/banner de geral.jpg" alt="" class="center-block">
            </div>
        </div>
